...
const Skill = ( {icon, skillName} ) => {
    ...
    <div className="skill grid grid-cols-4 p-2 items-center ">
        ...
        <p className="font-bold col-span-2">{ skillName }</p>
        <button className="px-2 py-1 hover:bg-gray-100/50 hover:shadow rounded-full text-white col-span-1 right-1 absolute ">Seguir</button>
      </div>
